...
WEATHERFLOW_COLLECTOR_API_RATE_LIMIT = int(os.getenv("WEATHERFLOW_COLLECTOR_API_RATE_LIMIT", 15))
...
WEATHERFLOW_COLLECTOR_INFLUXDB_BUCKET = os.getenv("WEATHERFLOW_COLLECTOR_INFLUXDB_BUCKET")
...
WEATHERFLOW_COLLECTOR_LOG_DIRECTORY = os.getenv("WEATHERFLOW_COLLECTOR_LOG_DIRECTORY", "logs")


# Module Enablement Flags
WEATHERFLOW_COLLECTOR_COLLECTOR_EXPORT_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_COLLECTOR_EXPORT_ENABLED", "False").lower() == "true"
)
...
WEATHERFLOW_COLLECTOR_STORAGE_INFLUXDB_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_STORAGE_INFLUXDB_ENABLED", "True").lower() == "true"
)
WEATHERFLOW_COLLECTOR_COLLECTOR_REST_EXPORT_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_COLLECTOR_REST_EXPORT_ENABLED", "False").lower() == "true"
)
WEATHERFLOW_COLLECTOR_COLLECTOR_REST_FORECASTS_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_COLLECTOR_REST_FORECASTS_ENABLED", "True").lower() == "true"
)
WEATHERFLOW_COLLECTOR_COLLECTOR_REST_IMPORT_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_COLLECTOR_REST_IMPORT_ENABLED", "False").lower() == "true"
)
WEATHERFLOW_COLLECTOR_COLLECTOR_REST_OBSERVATIONS_DEVICE_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_COLLECTOR_REST_OBSERVATIONS_DEVICE_ENABLED", "True").lower()
    == "true"
)
WEATHERFLOW_COLLECTOR_COLLECTOR_REST_OBSERVATIONS_STATION_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_COLLECTOR_REST_OBSERVATIONS_STATION_ENABLED", "False").lower()
    == "true"
)
WEATHERFLOW_COLLECTOR_COLLECTOR_REST_STATS_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_COLLECTOR_REST_STATS_ENABLED", "True").lower() == "true"
)
...
WEATHERFLOW_COLLECTOR_COLLECTOR_WEBSOCKET_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_COLLECTOR_WEBSOCKET_ENABLED", "True").lower() == "true"
)
WEATHERFLOW_COLLECTOR_PROVIDER_WEBSOCKET_SERVER_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_PROVIDER_WEBSOCKET_SERVER_ENABLED", "True").lower() == "true"
)
...
WEATHERFLOW_COLLECTOR_HANDLER_REST_STATS_SUPPRESS_WARNINGS_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_HANDLER_REST_STATS_SUPPRESS_WARNINGS_ENABLED", "True").lower()
    == "true"
)
...
WEATHERFLOW_COLLECTOR_STORAGE_FILE_COLLECTOR_REST_IMPORT_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_STORAGE_FILE_COLLECTOR_REST_IMPORT_ENABLED", "False").lower()
    == "true"
)

WEATHERFLOW_COLLECTOR_STORAGE_FILE_COLLECTOR_REST_EXPORT_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_STORAGE_FILE_COLLECTOR_REST_EXPORT_ENABLED", "False").lower()
    == "true"
)
...
WEATHERFLOW_COLLECTOR_STORAGE_FILE_COLLECTOR_UDP_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_STORAGE_FILE_COLLECTOR_UDP_ENABLED", "False").lower() == "true"
)
WEATHERFLOW_COLLECTOR_STORAGE_FILE_COLLECTOR_WEBSOCKET_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_STORAGE_FILE_COLLECTOR_WEBSOCKET_ENABLED", "False").lower()
    == "true"
)
WEATHERFLOW_COLLECTOR_STORAGE_FILE_COLLECTOR_REST_STATS_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_STORAGE_FILE_COLLECTOR_REST_STATS_ENABLED", "False").lower()
    == "true"
)


WEATHERFLOW_COLLECTOR_ENABLE_INFLUXDB_DATA_STRUCTURE_TRACKING = (
    os.getenv("WEATHERFLOW_COLLECTOR_ENABLE_INFLUXDB_DATA_STRUCTURE_TRACKING", "False").lower()
    == "true"
)
...
WEATHERFLOW_COLLECTOR_COLLECTOR_REST_IMPORT_FETCH_OBSERVATIONS_DELAY_MS = int(
    os.getenv("WEATHERFLOW_COLLECTOR_COLLECTOR_REST_IMPORT_FETCH_OBSERVATIONS_DELAY_MS", 200)
)
...
WEATHERFLOW_COLLECTOR_ENABLE_HEALTHCHECK_FORECAST = (
    os.getenv("WEATHERFLOW_COLLECTOR_ENABLE_HEALTHCHECK_FORECAST", "True").lower() == "true"
)
...
WEATHERFLOW_COLLECTOR_ENABLE_HEALTHCHECK_SOCKET = (
    os.getenv("WEATHERFLOW_COLLECTOR_ENABLE_HEALTHCHECK_SOCKET", "True").lower() == "true"
)
...
WEATHERFLOW_COLLECTOR_ENABLE_IMPORT_EXPORT_CACHE = (
    os.getenv("WEATHERFLOW_COLLECTOR_ENABLE_IMPORT_EXPORT_CACHE", "True").lower() == "true"
)
...
WEATHERFLOW_COLLECTOR_LOGGER_CONSOLE_USE_COLOR_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_LOGGER_CONSOLE_USE_COLOR_ENABLED", "True").lower() == "true"
)
...
WEATHERFLOW_COLLECTOR_LOGGER_FILE_USE_COLOR_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_LOGGER_FILE_USE_COLOR_ENABLED", "False").lower() == "true"
)
...
WEATHERFLOW_API_WEBSOCKET_URL = "wss://ws.weatherflow.com/swd/data?token=" + (
    WEATHERFLOW_COLLECTOR_API_TOKEN or ""
)
